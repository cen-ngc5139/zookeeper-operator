...
// +kubebuilder:webhook:path=/mutate-cache-ghostbaby-io-v1alpha1-workload,mutating=true,failurePolicy=fail,groups=cache.ghostbaby.io,resources=workloads,verbs=create;update,versions=v1alpha1,name=mworkload.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cache-ghostbaby-io-v1alpha1-workload,mutating=false,failurePolicy=fail,groups=cache.ghostbaby.io,resources=workloads,versions=v1alpha1,name=vworkload.kb.io
...
func (r *Workload) validateZooKeeper() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "cache.ghostbaby.io", Kind: "Workload"},
		r.Name, allErrs)
}
